...
#            (r'\Biggl', 'x', r'\Biggr'), 
            (r'\left', 'x', r'\right'),
            (r'\left', r'\frac{x}{y}', r'\right'),
            (r'\left', r'\frac{\frac{x}{y}}{z}', r'\right'),
            (r'\left', r'\frac{\frac{x}{y}}{\frac{z}{w}}', r'\right'),
            (r'\left', r'\frac{\frac{x}{y}}{\frac{z}{\frac{z}{w}}}', r'\right'),
            (r'\left', r'\frac{\frac{\frac{x}{y}}{y}}{\frac{z}{\frac{z}{w}}}', r'\right'),
        ]
        for delim in [
#            ('(', ')'), 
#            ('[', ']'),
